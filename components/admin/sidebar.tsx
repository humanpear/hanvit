  ...
  return (
    <div className="fixed left-0 top-0 flex flex-col w-60 h-screen bg-wood-10 p-3">
      ...
      <ul className="flex flex-col gap-2">
        <li>
          <button className={listStyle("/admin/estimate")} onClick={() => router.push('/admin/estimate')}>
            <Image
        ...
        <li>
          <button className={listStyle("/admin/slider")} onClick={() => router.push('/admin/slider')}>
            <Image
            ...
            />
            <div className="font-semibold hover:font-bold">슬라이드 이미지 관리</div>
          </button>
        </li>
        <li>
          <button className={listStyle("/admin/portfolio")} onClick={() => router.push('/admin/portfolio')}>
            <Image
        ...
        <li>
          <button id="setting" className={listStyle("/admin/setting")} onClick={() => router.push('/admin/setting')}>
            <Image
